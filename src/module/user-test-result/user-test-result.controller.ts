...
export class UserTestResultController {
  ...
  @ApiParam({
    name: 'idTestResult',
    description: 'ID của kết quả bài test cần xóa',
    example: 'uuid-test-result-1',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Nhận toàn bộ câu trả lời, chấm điểm tự động, lưu kết quả và cập nhật XP trong một lần gọi duy nhất.',
  })
  @ApiParam({
    name: 'idUser',
    description: 'ID của người dùng',
  ...
  @ApiResponse({
    status: 200,
    description: 'Hoàn thành và chấm điểm Writing thành công',
  })
  finishTestWriting(
  ...
  @ApiParam({
    name: 'idTestResult',
    description: 'ID của kết quả bài test cần reset',
    example: 'uuid-test-result-1',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Upload audio files cho các phần Speaking (Part 1, 2, 3) và chấm điểm bằng AI',
  })
    ...
    schema: {
      ...
      properties: {
        ...
        idSpeakingTask: {
          type: 'string',
          description:
            'ID của Speaking Task (optional, nếu không có sẽ lấy từ test)',
  ...
  @ApiResponse({
    status: 200,
    description:
      'Hoàn thành và chấm điểm Speaking thành công, cập nhật XP và streak',
  })
  @UseInterceptors(
    FileFieldsInterceptor([
